...
#
# 8 chunks × 8 CPUs = 64 cores running as background processes on one node.
# 700 integrals / 8 chunks ≈ 87 per chunk.
...
export MODEL=${MODEL:-checkpoints/hexabox_13M_biased/best_model.pt}
